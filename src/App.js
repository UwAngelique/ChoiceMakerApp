        ...
        <body className="App">
          <header className="body">
            <div className="brand">
              ...
              <h3 className="LogoText">Choice Maker App</h3>
            </div>
          ...
          <body>
            <div className="contentBody">
              <p>
                Type your question and help you make those choice that seemS too be difficult for you
                with random choice maker algorithm.
              </p>
